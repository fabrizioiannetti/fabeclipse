...
public class ImageView extends ViewPart {
	 ...
	 */
	public static final String ID = "fab.image.viewer.views.ImageView";
	...
	public void createPartControl(Composite parent) {
		imageButton = new Button(parent, SWT.FLAT);
		makeActions();
		hookContextMenu();
	...
	private void hookContextMenu() {
		...
		Menu menu = menuMgr.createContextMenu(imageButton);
	...
	private void showMessage(String message) {
		MessageDialog.openInformation(imageButton.getShell(), "Image", message);
	}
